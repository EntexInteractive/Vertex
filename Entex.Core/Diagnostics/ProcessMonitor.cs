...
namespace Entex.Shared.Diagnostics
{
    ...
    public class ProcessMonitor : IDisposable
    {
        ...
        /// <summary>
        /// Occurs when the <see cref="ProcessMonitor"/> detects high cpu usage.
        /// </summary>
        public event EventHandler<HighUtilizationEventArgs>? HighCpuDetected;

        /// <summary>
        /// Occurs when the <see cref="ProcessMonitor"/> detects high memory usage.
        /// </summary>
        public event EventHandler<HighUtilizationEventArgs>? HighRamDetected;
        ...
        {
            Refresh();
            if (CpuUsage >= 75) HighCpuDetected?.Invoke(this, new HighUtilizationEventArgs(this));
            //if (RamUsage >= ()) HighRamDetected?.Invoke(this, new HighUtilizationEventArgs(this));
        }
