using Entex.Shared.Extensions.Json;
using Newtonsoft.Json;

namespace Entex.Core
{
    /// <summary>
    ...
    public readonly struct UnixTime
    {
        ...
        /// </summary>
        public long TotalSeconds => (long)_timestamp.ToUniversalTime().Subtract(new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc)).TotalSeconds;
